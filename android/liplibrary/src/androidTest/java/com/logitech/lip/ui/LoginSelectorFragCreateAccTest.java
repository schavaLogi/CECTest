...
public class LoginSelectorFragCreateAccTest {
    ...
    public void isTitleCorrect() {
        titleBarText.check(matches(withText(R.string.lip_sign_up_create_id)));
    }
    ...
    public void googleButtonClick() throws InterruptedException {
    ...
    public void emailButtonClick() {
        emailButton.perform(closeSoftKeyboard(), click());
        pressBack();
    }
    ...
    public void signUpIsDescCorrect() {
        desc.check(matches(withText(R.string.lip_sign_up_with)));
    }
